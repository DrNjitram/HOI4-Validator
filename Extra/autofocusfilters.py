...
FOCUS_FILTER_POLITICAL_idea = ['trade_laws_cost_factor', 'navy_chief_cost_factor', 'air_chief_cost_factor', 'mobilization_laws_cost_factor', 'master_ideology_drift', 'economy_cost_factor', 'neutrality_drift', 'military_leader_cost_factor',
                               ...
                               'democratic_drift', 'legitimacy_daily', 'targeted_legitimacy_daily', 'political_power_gain', 'political_power_factor', 'political_power_cost', 'communism_drift', 'drift_defence_factor']
FOCUS_FILTER_RESEARCH_idea = ['research_speed_factor', 'research_bonus']
FOCUS_FILTER_INDUSTRY_idea = ['industry_air_damage_factor', 'production_speed_radar_station_factor', 'production_speed_anti_air_building_factor', 'production_speed_air_base_factor', 'production_speed_bunker_factor',
                              'industry_repair_factor', 'industry_free_repair_factor', 'production_speed_dockyard_factor', 'conversion_cost_mil_to_civ_factor', 'production_speed_synthetic_refinery_factor', 'max_fuel_factor',
                              'production_speed_infrastructure_factor', 'production_speed_industrial_complex_factor', 'fuel_gain_factor', 'production_speed_arms_factory_factor', 'production_speed',
                              'production_factory_max_efficiency_factor', 'line_change_production_efficiency_factor', 'production_speed_buildings_factor', 'conversion_cost_civ_to_mil_factor', 'industrial_capacity_factory',
                              'industrial_capacity_dockyard', 'consumer_goods_factor', 'production_factory_efficiency_gain_factor', 'production_factory_start_efficiency_factor', 'local_building_slots_factor', 'local_resources_factor',
                              'production_oil_factor', 'global_building_slots_factor']
...
FOCUS_FILTER_ARMY_BONUS_idea = ['special_forces_training_time_factor', 'command_power_gain', 'max_command_power', 'command_power_gain_mult', 'defense_bonus_against', 'attack_bonus_against', 'army_leader_start_level',
                                ...
                                'invasion_preparation', 'land_reinforce_rate', 'defence', 'offence', 'army_defence_factor', 'army_attack_factor', 'army_speed_factor', 'attrition', 'heat_attrition_factor', 'winter_attrition_factor',
                                'acclimatization_cold_climate_gain_factor', 'acclimatization_hot_climate_gain_factor', 'terrain_penalty_reduction', 'max_dig_in', 'dig_in_speed', 'dig_in_speed_factor', 'supply_consumption_factor',
                                'out_of_supply_factor', 'experience_gain_army', 'experience_gain_army_factor', 'experience_loss_factor', 'minimum_training_level', 'no_supply_grace', 'army_armor_speed_factor', 'army_armor_attack_factor',
                                'army_armor_defence_factor', 'army_artillery_attack_factor', 'army_artillery_defence_factor', 'army_infantry_attack_factor', 'army_infantry_defence_factor', 'special_forces_attack_factor',
                                'special_forces_defence_factor', 'cavalry_attack_factor', 'cavalry_defence_factor', 'mechanized_attack_factor', 'mechanized_defence_factor', 'motorized_attack_factor', 'motorized_defence_factor',
                                'air_paradrop_attack_factor', 'air_paradrop_defence_factor', 'air_paradrop_agility_factor']
FOCUS_FILTER_NAVY_BONUS_idea = ['naval_torpedo_screen_penetration_factor', 'navy_carrier_air_attack_factor', 'navy_carrier_air_targetting_factor', 'navy_carrier_air_agility_factor', 'navy_capital_ship_attack_factor',
                                'navy_capital_ship_defence_factor', 'navy_submarine_attack_factor', 'navy_submarine_defence_factor', 'navy_screen_attack_factor', 'navy_screen_defence_factor', 'naval_torpedo_range_factor',
                                'convoy_escort_efficiency', 'naval_retreat_chance', 'naval_retreat_speed', 'ships_at_battle_start', 'spotting_chance', 'navy_anti_air_attack_factor', 'sortie_efficiency', 'naval_hit_chance',
                                'naval_coordination', 'convoy_raiding_efficiency_factor', 'naval_speed_factor', 'navy_submarine_detection_factor', 'navy_max_range_factor', 'experience_gain_navy', 'experience_gain_navy_factor']
FOCUS_FILTER_AIRFORCE_BONUS_idea = ['air_defence_factor', 'air_bombing_targetting', 'air_attack_factor', 'air_ace_generation_chance_factor', 'enemy_army_bonus_air_superiority_factor', 'air_accidents_factor', 'air_night_penalty',
                                    'air_weather_penalty', 'air_range_factor', 'experience_gain_air', 'experience_gain_air_factor', 'naval_strike_attack_factor', 'naval_strike_targetting_factor', 'naval_strike_agility_factor',
                                    'air_interception_attack_factor', 'air_interception_defence_factor', 'air_interception_agility_factor', 'air_air_superiority_attack_factor', 'air_air_superiority_defence_factor',
                                    'air_air_superiority_agility_factor', 'air_close_air_support_attack_factor', 'air_close_air_support_defence_factor', 'air_close_air_support_agility_factor', 'air_strategic_bomber_attack_factor',
...
for filename in listdir(os.path.join(eaw_folder, "common", "national_focus")):
    ...
    if filename[:-4] not in ["FRN", "JES", "TAL_shared", "JER_shared", "WNG"]:
        continue
